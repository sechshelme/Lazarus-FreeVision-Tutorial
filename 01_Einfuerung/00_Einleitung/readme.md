...
<pre><code>ä = <font color="#FF0000">#132</font>  Ä = <font color="#FF0000">#142</font>
...
Da die Texte <b>PString</b> gespeichert sind, ist darauf zu achten, das man im Konstruktor (Init) schon genügend Specher für die Texte reserviert.<br>
Am einfachsten geht dies so, somit hat es dann genügend Platz noch für <b>world</b>.<br>
<pre><code>  StaticText := <b><font color="0000BB">new</font></b>(PStaticText, Init(Rect, <font color="#FF0000">'Hallo           '</font>));
